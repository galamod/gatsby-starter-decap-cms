...
nick.steal.licencekey : F6365F378948D2BA3E24661A0CF172B5695523C4BF151059B3826FC5BDC4B1B1#GHUG8IDHJ4BSFKHBSJDHJHIP0OLKPFMOKVC3AKIHU1HJGONUYH7GDX2HNLAK8MDL7N1JKN#8AB11020EA3E7DB60C6398A2670FB5EBC3DE26126CD0BF80C4B1C0385AABD4F9
...
```csharp
        public async Task AutoReg()
        {
            try
            {
                ...
                WebRequest request = WebRequest.Create($"https://galaxy.mobstudio.ru/services/?userID=0&password=&a=registration_register&age_confirmed=1&random={Random}");
                request.Method = "POST";
                request.Proxy = proxy;
